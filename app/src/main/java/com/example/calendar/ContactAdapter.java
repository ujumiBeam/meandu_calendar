...
public class ContactAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView genderTextView = (TextView) convertView.findViewById(R.id.textView3) ;
        TextView ageTextView = (TextView) convertView.findViewById(R.id.textView4) ;

        // Data Set(listViewItemList)에서 position에 위치한 데이터 참조 획득
        ContactItem listViewItem = ContactItemList.get(position);
    ...
    public void addItem(Drawable icon, String name, String number, String gender, String age) {
